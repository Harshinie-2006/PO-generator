...
The project includes a complete Jenkins CI/CD pipeline for automated builds and deployments.
- **Jenkinsfile**: Defines the build stages (Build, Push, Deploy).
- **Jenkins Setup**: A containerized Jenkins environment is available in the `jenkins/` directory.

See [JENKINS.md](./JENKINS.md) for full setup instructions.
